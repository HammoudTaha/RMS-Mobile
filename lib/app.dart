...
import 'features/bookings/prestantation/bloc/cancelBooking/cancel_booking_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) =>
              getIt<DeliveryAddressBloc>()..add(FetchDeliveryAddressesEvent()),
        ),
...
<<<<<<< HEAD
=======
        BlocProvider(create: (context) => CancelBookingBloc()),
        BlocProvider(create: (context) => TopRestarantBloc()),
